...
//contcts
    $ch = curl_init();
	curl_setopt($ch, CURLOPT_URL,"http://localhost/business-casual/api/controller/Select_all_users.php");
	curl_setopt($ch, CURLOPT_POST, 1);
	curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
	...
	if(  (is_array($recordClientNames) && sizeof($recordClientNames)>0))
	{
		...
		for($i=0; $i<$numberOfClients; $i++)
		{
           ...
           // $information .= "<div>";
            $information .= "<p><strong>Name : </strong>" .$recordClientNames[$i]['Name']." ".$recordClientNames[$i]['Surname'] ."</p>";
            $information .= "<p><strong>email : </strong>" . $recordClientNames[$i]['email'] ."</p>";
            $information .= "<p><strong>Linked To : </strong>" . $recordClientNames[$i]['Client_name']."(".$recordClientNames[$i]['ClientCode'].")" ."</p>";
            $information .= '<a  class="open-AddBookDialog btn btn-primary" href="http://localhost/business-casual/update_contact.php?id=' .$recordClientNames[$i]['id'] .'">unlink from client</a>';
            $information .= "<p>==============================================================</p>";
           // $information .= "<div>";
...
<body>
    ...
    <div class="brand">Client Connect</div>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Client Connect</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Link Contacts
...
<script>
    $(document).ready(function (e) {
        ...
        $.ajax({
                url: "api/controller/insert_contact.php",
        type: "POST",
